...
<Image src={"/images/Frame.jpg"} alt="logo" width={78.47} height={78.47}></Image>
            ...
            <ul
              ...
              <li className='mb-6 hidden max-lg:block'>
                <div className="flex items-center justify-between gap-4">
                  <Link href="/images"> <Image src={"/images/Frame.jpg"} alt="logo" width={78.47} height={78.47}className='w-36'  ></Image>
                  </Link>
                  <button
          ...
          <div className="flex items-center gap-x-6 gap-y-4 ml-auto">
            <div
              ...
              <input type='text' placeholder='Search ' className='w-full text-sm bg-transparent outline-none pr-2' />
